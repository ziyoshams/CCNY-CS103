	...
	for(int i = 0; i < 7; i++){
	 ...
	 do{
		 ...
		 if(choice == '?'){
			 ...
			 bot3.chooseDiscard();
			 bot4.chooseDiscard();
			 cout<<"\t"<<"Player 0 gave 1 " <<human.getDisCard()<<endl;
			 cout<<"\t"<<"Player 1 gave 2 " <<bot1.getDisCard()<<endl;
			 cout<<"\t"<<"Player 2 gave 3 " <<bot2.getDisCard()<<endl;
			 cout<<"\t"<<"Player 3 gave 4 " <<bot3.getDisCard()<<endl;
			 cout<<"\t"<<"Player 4 gave 0 " <<bot4.getDisCard()<<endl;
